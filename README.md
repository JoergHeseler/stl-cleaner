...
6. Use the **3D Print Toolbox** options:
   i. Click **Check All** to identify issues.
   ii. Use **Clean Up** > **Merge by Distance** to remove duplicate vertices.
   iii. Click **Make Manifold** to fix non-manifold geometry.
